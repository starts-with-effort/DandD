...
export default function EditUserPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch groups
        const groupsResponse = await axios.get(`${API_URL}core/groups/`, {
          headers: {
        ...
        // Fetch user data
        const userResponse = await axios.get(`${API_URL}core/users/${userId}/`, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
        ...
        // Set groups (convert to strings for form handling)
        if (userData.groups) {
          setValue('groups', userData.groups.map(g => g.toString()));
        }
  ...
  const onSubmit = async (data: UserFormData) => {
    ...
    try {
      ...
      await axios.put(`${API_URL}core/users/${userId}/`, userData, {
        headers: {
          Authorization: `Bearer ${token}`,
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {success && (
          <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-6">
            <p>Usuario actualizado exitosamente. Redirigiendo...</p>
          </div>
        )}
